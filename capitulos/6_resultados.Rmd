...
datos_tesis <- read_rds("~/GitHub/tesis_magister/datos/datos_tesis.rds")
juicios <- read_dta("~/GitHub/tesis_magister/datos/barsbargains_replication/barsbargains.dta")
datos_tesis <- datos_tesis %>% left_join(juicios %>% select(pais = country, anno = year, codigo_transicion = dtr_id, amnistias_dummy = ambin))
```

# VI RESULTADOS

## VI. 1. Justicia transicional y golpes de estado
...
## VI. 2. Justicia transicional y protección de los derechos humanos
